                ...
                <div className="py-10 px-4 sm:px-10">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-xl text-muted-foreground">
                            Estrutura de dados para armazenar e manipular
                ...
                "
                        ...
                        <TabsContent value="conteudo">
                            <div className="border rounded-lg p-6 bg-card">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Aprenda os conceitos fundamentais sobre
                                    listas, suas implementações e aplicações.
                                </p>
                        ...
                        <TabsContent value="visualization">
                            <div className="border rounded-lg p-6 bg-card">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Visualize o comportamento de uma lista e
                                    interaja com operações de adição, inserção e
                                    remoção para entender melhor o
                                    funcionamento.
                                </p>
                        ...
                        <TabsContent value="practice">
                            <div className="border rounded-lg p-6 bg-card">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Complete os desafios para testar seu
                        ...
                        <TabsContent value="challenge">
                            <div className="border rounded-lg p-6 bg-card">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Enfrente os desafios para aprimorar suas
                                    habilidades em listas.
                                </p>
