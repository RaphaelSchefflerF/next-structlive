...
export default function QuestaoPage() {
    ...
    const handleSubmit = async () => {
        ...
        setRespostasCorretas((prev) => ({
            ...prev,
            [index]:
                atividade.alternativas.find((a: any) => a.correta)?.texto || '',
        }));
                    ...
                    <CardContent>
                        ...
                        <div className="space-y-3 mb-4">
                            {atividade.alternativas?.map(
                                (alt: any, idx: number) => {
                                    ...
                                    const isRespostaCerta =
                                        alt.texto === respostaCorreta;
                                    const isRespostaUsuario =
                                        alt.texto ===
                                        alternativasSelecionadas[index];
                        ...
                        <div className="flex justify-between items-center max-w-[600px]">
                            ...
                            <Button
                                ...
                                disabled={
                                    !alternativa || respostasEnviadas[index]
                                }
                        ...
                        <div className="bg-white rounded-lg shadow-lg border overflow-hidden">
                            ...
                            <div className="p-4 space-y-2">
                                <p className="text-sm text-gray-600">
                                    Clique no botão ao lado para que nossa IA te
                                    explique por que sua resposta está certa ou
                                    errada, com base no conteúdo estudado.
                                </p>
